...
<body>
	...
	<h3><p align="center"><big>Form Pendaftaran Vaksinasi Covid-19</big><br/></p></h3>
	...
	<table width="500" border="0" align="center" cellpadding="0" cellspacing="1">
	    ...
	    <tr>
	        <td>NIK</td>
	        <td><input type="text" name="nik" size="20" required=""></td>
	    </tr>
	    <tr>
	        <td>Nama</td>
	    ...
	    <tr>
	        <td>Umur</td>
	        <td><input type="text" name="umur" size="20" required=""></td>
	    </tr>
	    <tr>
	        <td>Tanggal Lahir</td>
	        <td><input placeholder="yyyy/mm/dd" type="text" name="tgl_lahir" size="20" required=""></td>
	    </tr>
	    <tr>
	        <td>Nomor HP</td>
	        <td><input type="text" name="no_hp" size="20" required=""></td>
	    </tr>
	    <tr>
	        <td>Alamat</td>
